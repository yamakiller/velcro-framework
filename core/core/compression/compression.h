#ifndef V_FRAMEWORK_CORE_COMPRESSION_COMPRESSION_H
#define V_FRAMEWORK_CORE_COMPRESSION_COMPRESSION_H
...
namespace V {
     ...
     * "core/compression/zlib/zlib.h" and do it yourself!
     */
    class ZLib
    {
    public:
        ...
        typedef V::u16 Header;     ///< Typedef for the 2 byte zlib header.
...
#endif // V_FRAMEWORK_CORE_COMPRESSION_COMPRESSION_H