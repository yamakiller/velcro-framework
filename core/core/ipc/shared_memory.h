#ifndef V_FRAMEWORK_CORE_IPC_SHARED_MEMORY_H
#define V_FRAMEWORK_CORE_IPC_SHARED_MEMORY_H

#include <core/base.h>
#include <core/std/parallel/lock.h>
#include <core/ipc/shared_memory_common.h>
#include <core/ipc/shared_memory_platform.h>
...
namespace V
{
    ...
    */
    ...
    public:
        typedef VStd::lock_guard<SharedMemory> MemoryGuard;
        ...
        /// Naming is conforming with VStd::lock_guard/unique_lock/etc.
        void lock();
        bool try_lock();
        void unlock();
        /**
...
#endif // V_FRAMEWORK_CORE_IPC_SHARED_MEMORY_H