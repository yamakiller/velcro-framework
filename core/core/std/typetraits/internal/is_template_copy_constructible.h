#ifndef V_FRAMEWORK_CORE_STD_TYPETRAITS_INTERNAL_IS_TEMPLATE_COPY_CONSTRUCTIBLE_H
#define V_FRAMEWORK_CORE_STD_TYPETRAITS_INTERNAL_IS_TEMPLATE_COPY_CONSTRUCTIBLE_H
...
#endif // V_FRAMEWORK_CORE_STD_TYPETRAITS_INTERNAL_IS_TEMPLATE_COPY_CONSTRUCTIBLE_H