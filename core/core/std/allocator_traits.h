 ...
 * 
 */
#ifndef V_FRAMEWORK_CORE_STD_ALLOCATOR_TRAITS_H
#define V_FRAMEWORK_CORE_STD_ALLOCATOR_TRAITS_H
...
namespace VStd {
    inline namespace AllocatorInternal {
        ...
        //! otherwise attempt to fallback to the VStd pointer_type typedef.
        ...
        // Prefer the C++ standard max_size function before the VStd get_max_size function
    ...
    /*
    The allocator_traits class template provides the standardized way to access various properties of VStd allocators
    */
    ...
    struct allocator_traits
    {
        ...
        //! Extension VStd allocators supports supplying alignment
        ...
        {
            Internal::construct<T*>::single(ptr, VStd::forward<Args>(args)...);
        }
...
#endif // V_FRAMEWORK_CORE_STD_ALLOCATOR_TRAITS_H