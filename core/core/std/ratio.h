 ...
 *
 */
#ifndef V_FRAMEWORK_CORE_STD_RATIO_H
#define V_FRAMEWORK_CORE_STD_RATIO_H
...
namespace VStd {
    ...
    namespace Internal
    {
        ...
        template <V::s64 X, V::s64 Y>
        struct static_gcd
        {
            static const V::s64 value = static_gcd<Y, X % Y>::value;
        };

        template <V::s64 X>
        struct static_gcd<X, 0>
        {
            static const V::s64 value = X;
        };
        ...
        struct static_lcm
        {
            static const V::s64 value = X / static_gcd<X, Y>::value * Y;
        };

        template <V::s64 X>
        struct static_abs
        {
            static const V::s64 value = X < 0 ? -X : X;
        };

        template <V::s64 X>
        struct static_sign
        {
            static const V::s64 value = X == 0 ? 0 : (X < 0 ? -1 : 1);
        };

        template <V::s64 X, V::s64 Y, V::s64 = static_sign<Y>::value>
        class ll_add;

        template <V::s64 X, V::s64 Y>
        class ll_add<X, Y, 1>
        {
            static const V::s64 min =
                (1LL << (sizeof(V::s64) * CHAR_BIT - 1)) + 1;
            static const V::s64 max = -min;

            static char test[X <= max - Y];
            //    static_assert(X <= max - Y, "overflow in ll_add");
        public:
            static const V::s64 value = X + Y;
        };
        ...
        class ll_mul
        {
            static const V::s64 nan =
                (1LL << (sizeof(V::s64) * CHAR_BIT - 1));
            static const V::s64 min = nan + 1;
            static const V::s64 max = -min;
            static const V::s64 a_x = static_abs<X>::value;
            static const V::s64 a_y = static_abs<Y>::value;
        ...
        class ll_div
        {
            static const V::s64 nan = (1LL << (sizeof(V::s64) * CHAR_BIT - 1));
            static const V::s64 min = nan + 1;
            static const V::s64 max = -min;
    ...
    class ratio
    {
        ...
        static const V::s64 m_na = Internal::static_abs<N>::value;
        static const V::s64 m_da = Internal::static_abs<D>::value;
        static const V::s64 m_s = Internal::static_sign<N>::value  * Internal::static_sign<D>::value;
        static const V::s64 m_gcd = Internal::static_gcd<m_na, m_da>::value;
    public:
        static const V::s64 num = m_s * m_na / m_gcd;
        static const V::s64 den = m_da / m_gcd;
    };
    ...
    {
    private:
        static const V::s64 gcd_n1_n2 = Internal::static_gcd<R1::num, R2::num>::value;
        static const V::s64 gcd_d1_d2 = Internal::static_gcd<R1::den, R2::den>::value;
    public:
    ...
    {
    private:
        static const V::s64 gcd_n1_d2 = Internal::static_gcd<R1::num, R2::den>::value;
        static const V::s64 gcd_d1_n2 = Internal::static_gcd<R1::den, R2::num>::value;
    public:
        typedef ratio
    ...
    template <class R1, class R2>
    struct ratio_equal
        : public VStd::integral_constant<bool, (R1::num == R2::num&& R1::den == R2::den) > {};

    template <class R1, class R2>
    struct ratio_not_equal
        : public VStd::integral_constant<bool, !ratio_equal<R1, R2>::value> {};
    // ratio_less
    ...
    namespace Internal
    {
        ...
        {
            static const V::s64 max = -((1LL << (sizeof(V::s64) * CHAR_BIT - 1)) + 1);
        ...
        template <class R1, class R2, V::s64 S1 = static_sign<R1::num>::value, V::s64 S2 = static_sign<R2::num>::value>
        struct ratio_less
        {
    ...
    template <class R1, class R2>
    struct ratio_less
        : public VStd::integral_constant<bool, Internal::ratio_less<R1, R2>::value> {};

    template <class R1, class R2>
    struct ratio_less_equal
        : public VStd::integral_constant<bool, !ratio_less<R2, R1>::value> {};
    ...
    template <class R1, class R2>
    struct ratio_greater_equal
        : public VStd::integral_constant<bool, !ratio_less<R1, R2>::value> {};
}
...
#endif // V_FRAMEWORK_CORE_STD_RATIO_H