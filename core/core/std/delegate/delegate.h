#ifndef V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_H
#define V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_H
...
namespace VStd {
    namespace Internal {
        ...
        struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 2* sizeof(int) > {
            V_PUSH_DISABLE_WARNING(4121, "-Wunknown-warning-option") // alignment of a member was sensitive to packing
...
#endif // V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_H