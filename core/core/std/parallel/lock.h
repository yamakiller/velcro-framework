 ...
 * 
 */
#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_LOCK_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_LOCK_H
...
namespace VStd {
    ...
    public:
        ...
        V_FORCE_INLINE explicit lock_guard(mutex_type& mtx)
            : m_mutex(mtx) {
            m_mutex.lock();
        }
        V_FORCE_INLINE lock_guard(mutex_type& mtx, adopt_lock_t)
            : m_mutex(mtx) {
        }
    ...
    public:
        ...
        V_FORCE_INLINE void swap(unique_lock& rhs) {
            ...
            V_Assert(false, "Todo");
            //VStd::swap(m_mutex,rhs.m_mutex);
            //VStd::swap(m_owns,rhs.m_owns);
        }
...
#endif // V_FRAMEWORK_CORE_STD_PARALLEL_LOCK_H