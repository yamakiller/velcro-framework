 ...
 * 
 */
#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_COMBINABLE_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_COMBINABLE_H
...
namespace VStd {
     ...
     */
    template<typename T, class Allocator = VStd::allocator>
    class combinable {
    public:
        combinable()
    ...
    private:
        ...
        VStd::function<T ()> m_initFunc;
    };
}

#endif // V_FRAMEWORK_CORE_STD_PARALLEL_COMBINABLE_H