...
#ifndef V_FRAMEWORK_CORE_IO_SYSTEM_FILE_H
#define V_FRAMEWORK_CORE_IO_SYSTEM_FILE_H

#include <core/base.h>

#include <core/io/path/path_fwd.h>
#include <core/io/system_file_platform.h>
...
namespace V {
    namespace IO {
        ...
        public:
            ...
            using SizeType = V::IO::Internal::SizeType;
            using SeekSizeType = V::IO::Internal::SeekSizeType;
            using FileHandleType = V::IO::Internal::FileHandleType;
            ...
            V_FORCE_INLINE const char* Name() const    { return m_fileName.c_str(); }
            bool IsOpen() const;

            /// Return native handle to the file.
            V_FORCE_INLINE const FileHandleType&   NativeHandle() const    { return m_handle; }
            ...
            /// FindFiles
            typedef VStd::function<bool /* true to continue to enumerate otherwise false */ (const char* /* fileName*/, bool /* true if file, false if folder*/)>  FindFileCB;
            static void     FindFiles(const char* filter, FindFileCB cb);
            /// Get the time the file was last modified.
            static V::u64   ModificationTime(const char* fileName);
         ...
         *   V::IO::FileRedirector redirectStdoutToFile(1);
         *   redirectStdoutToFile.RedirectTo("myfile.txt");
         *   printf("Test"); // prints to myfile.txt
         *   redirectStdout.Reset();
         *   {
         *       V::IO::FileDescriptorRedirector redirectStdoutToNull(1);
         *       redirectStdoutToNull.RedirectTo(V::IO::NullFilename);
        ...
        public:
            ...
            void RedirectTo(VStd::string_view toFileName, Mode mode = Mode::Append);
            void Reset();
...
#endif // V_FRAMEWORK_CORE_IO_SYSTEM_FILE_H