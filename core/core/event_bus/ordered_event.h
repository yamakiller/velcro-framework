#ifndef V_FRAMEWORK_CORE_STD_EVENT_BUS_ORDERED_EVENT_H
#define V_FRAMEWORK_CORE_STD_EVENT_BUS_ORDERED_EVENT_H
...
namespace V
{
    ...
    private:
        ...
        mutable VStd::vector<OrderedEventHandler<Params...>*> m_handlers; //!< Active handlers
        mutable VStd::vector<OrderedEventHandler<Params...>*> m_addList; //!< Handlers added during a Signal, pending being added to the active handlers
...
#include <core/event_bus/ordered_event.inl>

#endif // V_FRAMEWORK_CORE_STD_EVENT_BUS_ORDERED_EVENT_H
