#include <core/event_bus/scheduled_event.h>
#include <core/event_bus/scheduled_event_handle.h>
#include <core/event_bus/ievent_scheduler.h>

namespace V
{
    ScheduledEvent::ScheduledEvent(const VStd::function<void()>& callback, const Name& eventName)
