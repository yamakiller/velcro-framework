#ifndef V_FRAMEWORK_CORE_EVENTS_Mode_H
#define V_FRAMEWORK_CORE_EVENTS_Mode_H
...
namespace V {
    // 地址策略
    enum class EventStreamAddressMode {
    ...
    enum class EventStreamHandlerMode {
...
#endif // V_FRAMEWORK_CORE_EVENTS_Mode_H