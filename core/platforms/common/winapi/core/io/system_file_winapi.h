#ifndef V_FRAMEWORK_CORE_PLATFORM_WINDOWS_IO_SYSTEM_FILE_WINAPI_H
...
namespace V {
    namespace IO {
        ...
        namespace PosixInternal
        {
            ...
            V_DEFINE_ENUM_BITWISE_OPERATORS(OpenFlags);
            ...
            V_DEFINE_ENUM_BITWISE_OPERATORS(PermissionModeFlags);
        ...
        } // namespace V::IO::PosixInternal
    } // namespace V::IO
} // namespace V

#endif // V_FRAMEWORK_CORE_PLATFORM_WINDOWS_IO_SYSTEM_FILE_WINAPI_H