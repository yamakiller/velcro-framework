#ifndef V_FRAMEWORK_TEST_UTILS_H
#define V_FRAMEWORK_TEST_UTILS_H

#include <string>
#include <vector>
#include <core/std/string/string.h>
#include <core/Outcome/Outcome.h>
...
namespace V
{
    namespace Test
    {
        ...
        public:
            ...
            VStd::string Resolve(const char* path) const;
        private:
...
#endif // V_FRAMEWORK_TEST_UTILS_H