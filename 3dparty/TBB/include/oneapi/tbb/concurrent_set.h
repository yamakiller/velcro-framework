...
namespace tbb {
    namespace detail {
        namespace d2 {
            ...
            template <typename Key, typename KeyCompare, typename RandomGenerator,
            ...
            class concurrent_set
                : public concurrent_skip_list<
                      set_traits<Key, Compare, concurrent_geometric_level_generator<32>,
                                 Allocator, false>> {
                using base_type = concurrent_skip_list<set_traits<
                    Key, Compare, concurrent_geometric_level_generator<32>, Allocator, false>>;
            ...
            concurrent_set(It, It, Alloc)
                -> concurrent_set<iterator_value_t<It>, std::less<iterator_value_t<It>>, Alloc>;
            ...
            class concurrent_multiset
                : public concurrent_skip_list<
                      set_traits<Key, Compare, concurrent_geometric_level_generator<32>,
                                 Allocator, true>> {
                using base_type = concurrent_skip_list<set_traits<
                    Key, Compare, concurrent_geometric_level_generator<32>, Allocator, true>>;
            ...
            concurrent_multiset(It, It, Alloc)
                -> concurrent_multiset<iterator_value_t<It>, std::less<iterator_value_t<It>>,
                                       Alloc>;
