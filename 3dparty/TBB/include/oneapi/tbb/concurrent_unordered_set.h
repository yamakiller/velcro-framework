    ...
    namespace detail {
        namespace d1 {
            ...
            class concurrent_unordered_set
                : public concurrent_unordered_base<
                      concurrent_unordered_set_traits<Key, Hash, KeyEqual, Allocator, false>> {
                using traits_type =
                    concurrent_unordered_set_traits<Key, Hash, KeyEqual, Allocator, false>;
            ...
            public:
                ...
                void merge(concurrent_unordered_set<key_type, OtherHash, OtherKeyEqual,
                ...
                template <typename OtherHash, typename OtherKeyEqual>
                void merge(concurrent_unordered_multiset<key_type, OtherHash, OtherKeyEqual,
                                                         allocator_type>& source)
                {
                    this->internal_merge(source);
                }
            ...
            template <typename It, typename Hash = std::hash<iterator_value_t<It>>,
            ...
            concurrent_unordered_set(It, It, size_t = {}, Hash = Hash(), KeyEq = KeyEq(),
                                     Alloc = Alloc())
                -> concurrent_unordered_set<iterator_value_t<It>, Hash, KeyEq, Alloc>;

            template <typename T, typename Hash = std::hash<T>,
                      typename KeyEq = std::equal_to<T>, typename Alloc = tbb::tbb_allocator<T>,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>,
                      typename = std::enable_if_t<!is_allocator_v<Hash>>,
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_set(std::initializer_list<T>, size_t = {}, Hash = Hash(),
            ...
            template <typename It, typename Alloc,
                      typename = std::enable_if_t<is_input_iterator_v<It>>,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>>
            concurrent_unordered_set(It, It, size_t, Alloc)
                -> concurrent_unordered_set<iterator_value_t<It>,
                                            std::hash<iterator_value_t<It>>,
            ...
            template <typename It, typename Hash, typename Alloc,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<Hash>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_set(It, It, size_t, Hash, Alloc)
                -> concurrent_unordered_set<iterator_value_t<It>, Hash,
                                            std::equal_to<iterator_value_t<It>>, Alloc>;

            template <typename T, typename Alloc,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>>
            concurrent_unordered_set(std::initializer_list<T>, size_t, Alloc)
            ...
            template <typename T, typename Hash, typename Alloc,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<Hash>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_set(std::initializer_list<T>, size_t, Hash, Alloc)
            ...
            class concurrent_unordered_multiset
                : public concurrent_unordered_base<
                      concurrent_unordered_set_traits<Key, Hash, KeyEqual, Allocator, true>> {
                using traits_type =
                    concurrent_unordered_set_traits<Key, Hash, KeyEqual, Allocator, true>;
                using base_type = concurrent_unordered_base<traits_type>;
            ...
            public:
                ...
                operator=(const concurrent_unordered_multiset&) = default;
                concurrent_unordered_multiset&
                operator=(concurrent_unordered_multiset&&) = default;
            ...
            template <typename It, typename Hash = std::hash<iterator_value_t<It>>,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(It, It, size_t = {}, Hash = Hash(), KeyEq = KeyEq(),
                                          Alloc = Alloc())
            ...
            template <typename T, typename Hash = std::hash<T>,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<KeyEq>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(std::initializer_list<T>, size_t = {}, Hash = Hash(),
                                          KeyEq = KeyEq(), Alloc = Alloc())
            ...
            template <typename It, typename Alloc,
                      typename = std::enable_if_t<is_input_iterator_v<It>>,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>>
            concurrent_unordered_multiset(It, It, size_t, Alloc)
                -> concurrent_unordered_multiset<iterator_value_t<It>,
                                                 std::hash<iterator_value_t<It>>,
                                                 std::equal_to<iterator_value_t<It>>, Alloc>;
            ...
            template <typename It, typename Hash, typename Alloc,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<Hash>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(It, It, size_t, Hash, Alloc)
                -> concurrent_unordered_multiset<iterator_value_t<It>, Hash,
                                                 std::equal_to<iterator_value_t<It>>, Alloc>;

            template <typename T, typename Alloc,
                      typename = std::enable_if_t<is_allocator_v<Alloc>>>
            concurrent_unordered_multiset(std::initializer_list<T>, size_t, Alloc)
            ...
            template <typename T, typename Hash, typename Alloc,
                      ...
                      typename = std::enable_if_t<!is_allocator_v<Hash>>,
                      typename = std::enable_if_t<!std::is_integral_v<Hash>>>
            concurrent_unordered_multiset(std::initializer_list<T>, size_t, Hash, Alloc)
