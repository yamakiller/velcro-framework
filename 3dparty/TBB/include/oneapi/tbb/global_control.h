...
#if __TBB_SUPPORTSWORKERSWAITING_IN_TERMINATE
...
namespace tbb {
    namespace detail {
        ...
        namespace r1 {
            ...
            TBB_EXPORT size_t __TBB_EXPORTED_FUNC global_control_active_value(int);
            ...
            TBB_EXPORT bool __TBB_EXPORTED_FUNC finalize(d1::task_scheduler_handle&,
                                                         std::intptr_t mode);
#endif
        }  // namespace r1
        ...
        namespace d1 {
            ...
            private:
                size_t        my_value;
                std::intptr_t my_reserved;  // TODO: substitution of global_control* not to
...
#endif  // __TBB_SUPPORTSWORKERSWAITING_IN_TERMINATE
