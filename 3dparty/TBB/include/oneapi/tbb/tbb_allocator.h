...
namespace tbb {
    namespace detail {
        ...
        namespace r1 {
            TBB_EXPORT void* __TBB_EXPORTED_FUNC allocate_memory(size_t size);
        ...
        namespace d1 {
            ...
            public:
                ...
                {
                    size_type max = ~(size_t(0)) / sizeof(value_type);
                    return (max > 0 ? max : 1);
                }
            ...
            inline bool operator==(const tbb_allocator<T>&, const tbb_allocator<U>&) noexcept
            {
                return true;
            }
