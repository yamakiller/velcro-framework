...
namespace tbb {
    namespace detail {
        ...
        namespace r1 {
            ...
            TBB_EXPORT void* __TBB_EXPORTED_FUNC allocate(d1::small_object_pool*& pool,
                                                          size_t number_of_bytes);
            TBB_EXPORT void __TBB_EXPORTED_FUNC  deallocate(d1::small_object_pool& pool,
                                                            void* ptr, size_t number_of_bytes,
                                                            const d1::execution_data& ed);
            TBB_EXPORT void __TBB_EXPORTED_FUNC  deallocate(d1::small_object_pool& pool,
                                                            void* ptr, size_t number_of_bytes);
        }  // namespace r1
            ...
            public:
                ...
                Type* new_object(execution_data& ed, Args&&... args)
                {
                    ...
                    auto constructed_object =
                        new (allocated_object) Type(std::forward<Args>(args)...);
