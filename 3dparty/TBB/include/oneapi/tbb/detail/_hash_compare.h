        ...
        namespace d1 {
            ...
            public:
                ...
                template <typename K, typename = typename std::enable_if<
                                          is_transparent_hash::value, K>::type>
                ...
                template <
                    ...
                    typename = typename std::enable_if<is_transparent_hash::value, K1>::type>
            ...
            public:
                size_t hash(const Key& a) const
                {
                    return my_hash_func(a);
                }
#if defined(_MSC_VER) && _MSC_VER <= 1900
    #pragma warning(push)
    // MSVC 2015 throws a strange warning: 'size_t': forcing value to bool 'true' or
    // 'false'
    #pragma warning(disable : 4800)
#endif
                bool equal(const Key& a, const Key& b) const
                {
                    return my_key_equal(a, b);
                }
#if defined(_MSC_VER) && _MSC_VER <= 1900
    #pragma warning(pop)
#endif
        ...
        inline namespace d0 {
            ...
            concept hash_compare = std::copy_constructible<HashCompare> &&
                                   requires(const std::remove_reference_t<HashCompare>& hc,
...
namespace std {
    ...
    // Apple clang and MSVC defines their own specializations for std::hash<std::basic_string<T,
    // Traits, Alloc>>
    ...
    public:
        size_t operator()(const std::basic_string<CharT, Traits, Allocator>& s) const
        {
            size_t h = 0;
    ...
    private:
        static constexpr size_t hash_multiplier =
            tbb::detail::select_size_t_constant<2654435769U, 11400714819323198485ULL>::value;
