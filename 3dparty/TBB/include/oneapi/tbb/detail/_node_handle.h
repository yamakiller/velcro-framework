...
namespace tbb {
    namespace detail {
        namespace d1 {
            ...
            // Regular friend declaration is not convenient because classes which use node
            // handle can be placed in the different versioning namespaces.
            ...
            class node_handle<Key, Key, Node, Allocator>
                : public node_handle_base<Key, Node, Allocator> {
