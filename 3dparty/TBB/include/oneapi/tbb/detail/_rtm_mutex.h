...
namespace tbb {
    ...
    #pragma warning(disable : 4324)
            ...
            private:
                enum class rtm_state { rtm_none, rtm_transacting, rtm_real };
            ...
            public:
                ...
                public:
                    ...
                    constexpr scoped_lock()
                        : m_mutex(nullptr), m_transaction_state(rtm_state::rtm_none)
                    {
                    }

                    //! Acquire lock on given mutex.
                    scoped_lock(rtm_mutex& m)
                        : m_mutex(nullptr), m_transaction_state(rtm_state::rtm_none)
                    {
                        acquire(m);
                    }
        ...
        namespace r1 {
            ...
            TBB_EXPORT void __TBB_EXPORTED_FUNC acquire(d1::rtm_mutex&,
                                                        d1::rtm_mutex::scoped_lock&,
                                                        bool only_speculate = false);
            //! Detail try_acquire lock.
            TBB_EXPORT bool __TBB_EXPORTED_FUNC try_acquire(d1::rtm_mutex&,
                                                            d1::rtm_mutex::scoped_lock&);
            //! Detail release lock.
        ...
        namespace d1 {
            ...
            inline void rtm_mutex::scoped_lock::release()
            {
                ...
                __TBB_ASSERT(m_transaction_state != rtm_state::rtm_none,
