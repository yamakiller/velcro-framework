...
#include <vcore/std/string/fixed_string_platform.inl>
...
namespace VStd
{
    ...
    {
        assign(VStd::move(rhs));
    }

    // #9
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr basic_fixed_string<Element, MaxElementCount, Traits>::basic_fixed_string(VStd::initializer_list<Element> ilist)
    {
    ...
    {
        VStd::basic_string_view<Element, Traits> view = convertibleToView;
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr basic_fixed_string<Element, MaxElementCount, Traits>::operator VStd::basic_string_view<Element, Traits>() const
    {
    ...
    {
        return assign(VStd::forward<basic_fixed_string>(rhs));
    }
    template<class Element, size_t MaxElementCount, class Traits>
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::operator=(VStd::initializer_list<Element> ilist) -> basic_fixed_string&
    {
        return assign(ilist);
    }
    template<class Element, size_t MaxElementCount, class Traits>
    ...
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::operator=(const T& convertibleToView)
        ->VStd::enable_if_t<is_convertible_v<const T&, basic_string_view<Element, Traits>> && !is_convertible_v<const T&, const Element*>, basic_fixed_string&>
    {
    ...
    {   // append rhs [rhsOffset, rhsOffset + count)
        ...
        VSTD_CONTAINER_ASSERT(Capacity - m_size > count && m_size + count >= m_size,
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::append(VStd::initializer_list<Element> ilist) -> basic_fixed_string&
    {   // append [first, last)
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::assign(VStd::initializer_list<Element> ilist) -> basic_fixed_string&
    {
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::insert(const_iterator insertPos,
        VStd::initializer_list<Element> ilist) -> iterator
    {   // insert [_First, _Last) at _Where
    ...
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::replace(const_iterator first, const_iterator last,
        const basic_fixed_string& rhs) -> basic_fixed_string&
    {
        return replace(VStd::distance(cbegin(), first), VStd::distance(first, last), rhs);
    }
    ...
    {   // replace [first, last) with [ptr, ptr + count)
        return replace(VStd::distance(cbegin(), first), VStd::distance(first, last), ptr, count);
    }
    ...
    {   // replace [first, last) with [ptr, <null>)
        return replace(VStd::distance(cbegin(), first), VStd::distance(first, last), ptr);
    }
    template<class Element, size_t MaxElementCount, class Traits>
    template<typename T>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::replace(const_iterator first, const_iterator last,
    ...
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::replace(const_iterator first, const_iterator last,
        VStd::initializer_list<Element> ilist) -> basic_fixed_string&
    {   // replace [first, last) with [first2,last2)
    ...
    {
        VSTD_CONTAINER_ASSERT(m_size != 0, "VStd::fixed_string::front - string is empty!");
        pointer data = m_buffer;
        return data[0];
    }
    ...
    {
        VSTD_CONTAINER_ASSERT(m_size != 0, "VStd::fixed_string::back - string is empty!");
        pointer data = m_buffer;
    ...
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::find(const T& convertibleToView, size_type offset) const
        -> VStd::enable_if_t<is_convertible_v<const T&, basic_string_view<Element, Traits>> && !is_convertible_v<const T&, const Element*>, size_type>
    {
        basic_string_view<Element, Traits> view = convertibleToView;
    ...
    inline constexpr auto basic_fixed_string<Element, MaxElementCount, Traits>::starts_with(const T& prefix) const
        -> VStd::enable_if_t<is_convertible_v<const T&, basic_string_view<Element, Traits>> && !is_convertible_v<const T&, const Element*>, bool>
    {
    ...
    inline decltype(auto) basic_fixed_string<Element, MaxElementCount, Traits>::format_arg(const char* format, va_list argList)
    {
        ...
        const int len = v_vscprintf(format, argListCopy);
        va_end(argListCopy);
        if (len > 0)
        {
            result.resize(len);
    ...
    {
        VSTD_CONTAINER_ASSERT(newSize <= Capacity, "New string size of %zu cannot fit in a fixed_string of size %zu", newSize, Capacity);
        ...
        basic_fixed_string<Element, MaxElementCount, Traits>&& rhs)
    {
        ...
        {
            return VStd::move(lhs.append(rhs)); // No need to create copy since lhs is an r-value
        }
        else
        {
            using size_type = typename basic_fixed_string<Element, MaxElementCount, Traits>::size_type;
            return VStd::move(rhs.insert(size_type(0), VStd::move(lhs)));
        }
    }
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr basic_fixed_string<Element, MaxElementCount, Traits> operator+(basic_fixed_string<Element, MaxElementCount, Traits>&& lhs,
        const basic_fixed_string<Element, MaxElementCount, Traits>& rhs)
    {
        return VStd::move(lhs.append(rhs));
    }
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr basic_fixed_string<Element, MaxElementCount, Traits> operator+(basic_fixed_string<Element, MaxElementCount, Traits>&& lhs,
        const Element* rhs)
    ...
    {
        using size_type = typename basic_fixed_string<Element, MaxElementCount, Traits>::size_type;
        return VStd::move(rhs.insert(size_type(0), lhs));
    }
    template<class Element, size_t MaxElementCount, class Traits>
    inline constexpr basic_fixed_string<Element, MaxElementCount, Traits> operator+(const Element* lhs,
        basic_fixed_string<Element, MaxElementCount, Traits>&& rhs)
    ...
    {
        using size_type = typename basic_fixed_string<Element, MaxElementCount, Traits>::size_type;
        return VStd::move(rhs.insert(size_type(0), 1, lhs));
    }
