 ...
 * 
 */
#ifndef V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_RECORDS_H
#define V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_RECORDS_H

#include <vcore/base.h>
#include <vcore/std/algorithm.h>

#include <vcore/std/function/function_fwd.h> // for callbacks
...
namespace V {
    namespace Debug {
        ...
        */
        ...
        using AllocationRecordsType = VStd::unordered_map<void*, AllocationInfo, VStd::hash<void*>, VStd::equal_to<void*>, OSStdAllocator>;
         ...
         */
        using AllocationInfoCBType = VStd::function<bool (void*, const AllocationInfo&, unsigned char)>;
        /**
        ...
        struct GuardValue
        {
            ...
            void ValidateWithAssert() const { V_Assert(m_value == m_defValue, "Guard value doesn't match! Value: 0x%08x should be: 0x%08x", m_value, m_defValue); }
        private:
            u32     m_value;
        };
        ...
        struct Magic16 {
            ...
            V_FORCE_INLINE Magic16()  { m_value = (m_defValue ^ (u16)((size_t) this)); }
            V_FORCE_INLINE ~Magic16() { m_value = 0; }
            V_FORCE_INLINE bool Validate() const { return m_value == (m_defValue^ (u16)((size_t) this)); }
        private:
            u16     m_value;
        };
        ...
        */
        struct Magic32
        {
            ...
            V_FORCE_INLINE Magic32()
            {
                m_value = (m_defValue ^ (u32)((size_t) this));
            }
            V_FORCE_INLINE ~Magic32() { m_value = 0; }
            V_FORCE_INLINE bool Validate() const { return m_value == (m_defValue ^ (u32)((size_t) this)); }
        private:
            u32     m_value;
        };
        ...
        */
        ...
        public:
            ...
            //////////////////////////////////////////////////////////////////////////
            // lock interface (can be used with std/VStd::lock)
            void    lock();
            bool    try_lock();
            void    unlock();
            //////////////////////////////////////////////////////////////////////////
            ...
            V_FORCE_INLINE Debug::AllocationRecordsType& GetMap()  { return m_records; }
        ...
        protected:
            ...
            mutable VStd::recursive_mutex   m_recordsMutex;
            Mode                            m_mode;
...
#endif // V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_RECORDS_H