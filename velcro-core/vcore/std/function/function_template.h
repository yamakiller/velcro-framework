 ...
 *
 */
#ifndef V_FRAMEWORK_CORE_STD_FUNCTION_TEMPLATE_H
#define V_FRAMEWORK_CORE_STD_FUNCTION_TEMPLATE_H

#include <vcore/std/function/function_base.h>
...
namespace VStd
{
    namespace Internal
    {
        namespace function_util
        {
            ...
            struct invoke_void_return_wrapper
            {
                ...
                {
                    return VStd::invoke(VStd::forward<Args>(args)...);
                }
            };
            template<>
            struct invoke_void_return_wrapper<void>
            {
                ...
                {
                    VStd::invoke(VStd::forward<Args>(args)...);
                }
            };
            ...
            template<typename FunctionType, typename Tag, typename Allocator = VStd::allocator>
            struct get_invoker { };
            ...
            private:
                ...
                static R call(function_buffer& function_ptr, Args&&... args)
                {
                    ...
                    return invoke_void_return_wrapper<R>::call(f, VStd::forward<Args>(args)...);
                }
            };
            template<typename R, typename... Args>
            struct get_invoker<R(Args...), function_ptr_tag, VStd::allocator>
            {
                template<typename FunctionPtr>
                static basic_vtable<R, Args...> create_vtable()
                {
            ...
            template<typename R, typename... Args>
            struct get_invoker<R(Args...), member_ptr_tag, VStd::allocator>
            {
                template<typename MemberPtr>
                static basic_vtable<R, Args...> create_vtable()
                {
            ...
            template<typename R, typename... Args>
            struct get_invoker<R(Args...), function_obj_tag, VStd::allocator>
            {
                template<typename FunctionObj>
                static basic_vtable<R, Args...> create_vtable()
                {
            ...
            */
            ...
            struct basic_vtable
            {
                ...
                bool assign_to(F&& f, function_buffer& functor)
                {
                    ...
                    return assign_to(VStd::forward<F>(f), functor, tag());
                }
                template<typename F, typename Allocator>
                bool assign_to_a(F&& f, function_buffer& functor, Allocator a)
                {
                    typedef typename get_function_tag<F>::type tag;
                    return assign_to_a(VStd::forward<F>(f), functor, a, tag());
                }
            ...
            private:
                ...
                template<typename FunctionObj>
                void
                assign_functor(FunctionObj&& f, function_buffer& functor, VStd::true_type)
                {
                    using RawFunctorObjType = VStd::decay_t<FunctionObj>;
                    VStd::construct_at(reinterpret_cast<RawFunctorObjType*>(&functor), RawFunctorObjType(VStd::forward<FunctionObj>(f)));
                }
                template<typename FunctionObj, typename Allocator>
                void
                assign_functor_a(FunctionObj&& f, function_buffer& functor, Allocator, VStd::true_type)
                {
                    assign_functor(VStd::forward<FunctionObj>(f), functor, VStd::true_type());
                }

                // Assign to a function object allocated on the heap.
                template<typename FunctionObj>
                void assign_functor(FunctionObj&& f, function_buffer& functor, VStd::false_type)
                {
                    using RawFunctorObjType = VStd::decay_t<FunctionObj>;
                    VStd::allocator a;
                    functor.obj_ptr = new (a.allocate(sizeof(RawFunctorObjType), VStd::alignment_of<RawFunctorObjType>::value))RawFunctorObjType(VStd::forward<FunctionObj>(f));
                }
                template<typename FunctionObj, typename Allocator>
                void
                assign_functor_a(FunctionObj&& f, function_buffer& functor, const Allocator& a, VStd::false_type)
                {
                    using RawFunctorObjType = VStd::decay_t<FunctionObj>;
                    typedef functor_wrapper<RawFunctorObjType, Allocator> functor_wrapper_type;
                    functor_wrapper_type* new_f = new (const_cast<Allocator&>(a).allocate(sizeof(functor_wrapper_type), VStd::alignment_of<functor_wrapper_type>::value))functor_wrapper_type(VStd::forward<FunctionObj>(f), a);
                ...
                {
                    using RawFunctorObjType = VStd::decay_t<FunctionObj>;
                    if (!VStd::Internal::function_util::has_empty_target(VStd::addressof(f)))
                    {
                        assign_functor(VStd::forward<FunctionObj>(f), functor, VStd::integral_constant<bool, function_allows_small_object_optimization<RawFunctorObjType>::value>());
                        return true;
                    }
                    else
                    {
                ...
                assign_to_a(FunctionObj&& f, function_buffer& functor, Allocator a, function_obj_tag)
                {
                    ...
                    if (!VStd::Internal::function_util::has_empty_target(VStd::addressof(f)))
                    {
                        assign_functor_a(VStd::forward<FunctionObj>(f), functor, a, VStd::integral_constant<bool, function_allows_small_object_optimization<RawFunctorObjType>::value>());
                        return true;
                    }
                    else
                    {
                ...
                {
                    if (!VStd::Internal::function_util::has_empty_target(&f.get()))
                    {
                        functor.obj_ref.obj_ptr = (void*)&f.get();
                        functor.obj_ref.is_const_qualified = is_const<FunctionObj>::value;
                        functor.obj_ref.is_volatile_qualified = VStd::is_volatile<FunctionObj>::value;
                        return true;
                    }
                    else
                    {
    ...
    private:
        typedef VStd::Internal::function_util::basic_vtable<R, Args...>  vtable_type;
    public:
        ...
        function_intermediate(Functor&& f, enable_if_t<!is_integral<Functor>::value && !is_same<remove_cvref_t<Functor>, function_intermediate>::value, int> = 0)
            : function_base() {
            this->assign_to(VStd::forward<Functor>(f));
        }
        ...
        function_intermediate(Functor&& f, Allocator a, enable_if_t<!is_integral<Functor>::value && !is_same<remove_cvref_t<Functor>, function_intermediate>::value, int> = 0)
            : function_base()  {
            this->assign_to_a(VStd::forward<Functor>(f), a);
        }
        ...
        // Move assignment from another VSTD_FUNCTION_FUNCTION
    ...
    private:
        void assign_to_own(const function_intermediate& f) {
            if (!f.empty()) {
                ...
                f.vtable->manager(f.functor, this->functor, VStd::Internal::function_util::clone_functor_tag);
            }
        }
        ...
        void assign_to(Functor&& f) {
            ...
            if (stored_vtable.assign_to(VStd::forward<Functor>(f), functor)) {
        ...
        void assign_to_a(Functor&& f, const Allocator& a)  {
            ...
            if (stored_vtable.assign_to_a(VStd::forward<Functor>(f), functor, a)) {
                vtable = &stored_vtable.base;
            } else {
                vtable = 0;
            }
    ...
    {
        V_Assert(!this->empty(), "Bad function call!");
        return reinterpret_cast<const vtable_type*>(vtable)->invoker(this->functor, VStd::forward<Args>(args)...);
    }
    ...
    public:
        ...
        function(Functor&& f, enable_if_t<!is_integral<Functor>::value && !is_same<remove_cvref_t<Functor>, self_type>::value, int> = 0)
            : base_type(VStd::forward<Functor>(f))
        {}
        template<typename Functor, typename Allocator>
        function(Functor&& f, const Allocator& a, enable_if_t<!is_integral<Functor>::value && !is_same<remove_cvref_t<Functor>, self_type>::value, int> = 0)
            : base_type(VStd::forward<Functor>(f), a)
        {}
        ...
        operator=(Functor&& f)
        {
            self_type(VStd::forward<Functor>(f)).swap(*this);
            return *this;
        }
        ...
        R operator()(Args... args) const
        {
            return base_type::operator()(VStd::forward<Args>(args)...);
        }
    };

    // VStd::function deduction guides
    template<class R, class... ArgTypes>
    function(R(*)(ArgTypes...)) -> function<R(ArgTypes...)>;

    template<class F, class = enable_if_t<VStd::Internal::has_call_operator_v<F>>>
