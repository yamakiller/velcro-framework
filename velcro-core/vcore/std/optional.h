 ...
 *
 */
#ifndef V_FRAMEWORK_CORE_STD_OPTIONAL_H
#define V_FRAMEWORK_CORE_STD_OPTIONAL_H
...
namespace VStd {
    ...
    namespace Internal {
        ...
        public:
            ...
            {
                V_Assert(this->m_engaged, "Optional does not have a value");
            ...
            {
                V_Assert(this->m_engaged, "Optional does not have a value");
                return VStd::move(this->m_object);
            }
            /*constexpr*/ T&& value()&&
            {
                V_Assert(this->m_engaged, "Optional does not have a value");
            ...
            {
                ::new((void*)VStd::addressof(this->m_object)) T(forward<Args>(args)...);
                this->m_engaged = true;
            }
        ...
        public:
            ...
            {
                this->construct_from(VStd::move(rhs));
            }
        ...
        public:
            ...
            {
                this->assign_from(VStd::move(rhs));
                return *this;
            }
        };
        ...
        // VStd::is_assignable<optional<T>&, optional<T>&> yield the same
        // value as VStd::is_assignable<T&, T&>
    ...
    public:
        ...
        void swap(optional& rhs)
        {
            ...
            if (this->has_value())
            {
                ...
                {
                    rhs.construct(VStd::move(this->value()));
                    this->reset();
                }
            }
            else
            {
                if (rhs.has_value())
                {
                    this->construct(VStd::move(rhs.value()));
                    rhs.reset();
                }
            }
        }
        ...
        {
            return VStd::addressof(this->value());
        }
        ...
        {
            return this->m_engaged ? VStd::move(this->value()) : static_cast<T>(forward<U>(v));
        }
...
#endif // V_FRAMEWORK_CORE_STD_OPTIONAL_H