#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_QUEUE_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_QUEUE_H
...
#endif // V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_QUEUE_H