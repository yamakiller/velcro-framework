#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_FREE_INTRUSIVE_STACK_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_FREE_INTRUSIVE_STACK_H
...
namespace VStd
{
    ...
    struct lock_free_intrusive_stack_node
    {
        ...
        ~lock_free_intrusive_stack_node()
        {
            VSTD_CONTAINER_ASSERT(m_next == 0, "VStd::lock_free_intrusive_stack_node - intrusive node is being destroyed while still a member of a list!");
        }
#endif
        T* m_next;
    };
...
#ifdef V_DEBUG_BUILD
        VSTD_CONTAINER_ASSERT(!newHookNode->m_next, "Node is already in an intrusive list");
#endif
...
#endif // V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_FREE_INTRUSIVE_STACK_H