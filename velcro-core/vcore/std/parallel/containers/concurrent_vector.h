#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_CONCURRENT_VECTOR_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_CONCURRENT_VECTOR_H
...
namespace VStd
{
     ...
     * Otherwise, use something else (like an VStd::list with a mutex).
     *
     ...
     */
    template<typename T, typename Allocator = VStd::allocator,
...
#endif // V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_CONCURRENT_VECTOR_H