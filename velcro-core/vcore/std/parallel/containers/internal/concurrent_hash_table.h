#ifndef V_FRAMEWORK_CORE_STD_PARALLE_CONTAINERS_INTERNAL_CONCURRENT_HASH_TABLE_H
#define V_FRAMEWORK_CORE_STD_PARALLE_CONTAINERS_INTERNAL_CONCURRENT_HASH_TABLE_H

#include <vcore/std/hash.h> //for primes list
...
#include <vcore/std/parallel/allocator_concurrent_static.h>
...
namespace VStd
{
    namespace Internal
    {
        ...
        public:
            ...
            typedef VStd::list<typename Traits::value_type, allocator_type> list_type;
            typedef typename list_type::size_type size_type;

            typedef list_type vector_value_type;
            typedef VStd::vector<vector_value_type, allocator_type> vector_type;
            ...
            void swap(this_type& rhs)
            {
                ...
                VStd::swap(m_startBucket, rhs.m_startBucket);
                VStd::swap(m_buckets, rhs.m_buckets);
        ...
        public:
            ...
            typedef typename Traits::allocator_type allocator_type;
            typedef VStd::list<typename Traits::value_type, allocator_ref<element_allocator_type> > list_type;
            typedef typename list_type::size_type size_type;
        ...
        public:
            ...
            void rehash(size_type numBucketsMin)
            {
                ...
                m_storage.rehash(this, VStd::GetMax(loadMinNumBuckets, numBucketsMin));
                release_all();
            }
...
#endif // V_FRAMEWORK_CORE_STD_PARALLE_CONTAINERS_INTERNAL_CONCURRENT_HASH_TABLE_H