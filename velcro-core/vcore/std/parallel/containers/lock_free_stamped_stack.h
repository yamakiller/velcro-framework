#ifndef V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_STACK_H
#define V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_STACK_H

#include <vcore/std/parallel/containers/lock_free_stack.h>
...
namespace VStd
{
    ...
    */
    ...
    inline lock_free_stamped_stack<T, Allocator>::lock_free_stamped_stack()
    {
        ...
        V_Assert(m_allocator.is_stale_read_allowed(), "Allocator for lock_free_stamped_stack must allow stale reads");
...
#endif // V_FRAMEWORK_CORE_STD_PARALLEL_CONTAINERS_LOCK_STAMPED_STACK_H