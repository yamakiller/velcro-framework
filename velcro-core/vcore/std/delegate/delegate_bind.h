#ifndef V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_BIND_H
#define V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_BIND_H
...
//      using VStd (or tr1 or boost)::bind;
...
#endif // V_FRAMEWORK_CORE_STD_DELEGATE_DELEGATE_BIND_H