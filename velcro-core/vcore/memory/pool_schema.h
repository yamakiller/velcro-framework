#ifndef V_FRAMEWORK_CORE_MEMORY_POOL_SCHEMA_H
#define V_FRAMEWORK_CORE_MEMORY_POOL_SCHEMA_H
...
namespace V
{
    ...
    public:
        ...
        */
        struct Descriptor
        {
            ...
            size_t              MinAllocationSize;    ///< Minimal allocation size >= 8 bytes and power of 2
            size_t              MaxAllocationSize;    ///< Maximum allocation size
            bool                IsDynamic;            ///< True if we allocate pages at runtime, false if we allocate at create.
            /**
             ...
             */
            unsigned int        NumStaticPages;
            IAllocatorAllocate* PageAllocator;        ///< If you provide this interface we will use it for page allocations, otherwise SystemAllocator will be used.
        };
    ...
    protected:
        ...
        static V_THREAD_LOCAL ThreadPoolData*  m_threadData;
    };

    template<class Allocator>
    V_THREAD_LOCAL ThreadPoolData* ThreadPoolSchemaHelper<Allocator>::m_threadData = 0;
} // namespace V


#endif // V_FRAMEWORK_CORE_MEMORY_POOL_SCHEMA_H