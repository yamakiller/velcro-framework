#ifndef V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_OVERRIDE_SHIM_H
#define V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_OVERRIDE_SHIM_H
...
namespace V {
    ...
    namespace Internal {
        ...
        */
        ...
        private:
            class StdAllocationSrc : public VStdIAllocator
            {
            public:
                StdAllocationSrc(IAllocatorAllocate* schema = nullptr) : VStdIAllocator(schema)
                {
                }
            };

            typedef VStd::mutex mutex_type;
            typedef VStd::lock_guard<mutex_type> lock_type;
            typedef VStd::unordered_set<void*, VStd::hash<void*>, VStd::equal_to<void*>, StdAllocationSrc> AllocationSet;
...
#endif // V_FRAMEWORK_CORE_MEMORY_ALLOCATOR_OVERRIDE_SHIM_H