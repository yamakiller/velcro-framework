#ifndef V_FRAMEWORK_CORE_CONSOLE_CONSOLE_FUNCTOR_H
#define V_FRAMEWORK_CORE_CONSOLE_CONSOLE_FUNCTOR_H

#include <stdint.h>
#include <vcore/base.h>
#include <vcore/math/type_id.h>
...
namespace V
{
    ...
    public:
        ...
        ConsoleFunctorBase(const char* name, const char* desc, ConsoleFunctorFlags flags, const V::TypeId& typeId);
        ...
        //! @param flags   a set of flags that mutate the behaviour of the functor
        //! @param typeId  the TypeId associated with this console functor
        ConsoleFunctorBase(V::IConsole& console, const char* name, const char* desc, ConsoleFunctorFlags flags, const TypeId& typeId);
    ...
    public:
        ...
        using FunctorUnion = VStd::variant<RawFunctorSignature, MemberFunctorSignature>;
    ...
    public:
        ...
        ConsoleFunctor(V::IConsole& console, const char* name, const char* desc, ConsoleFunctorFlags flags, const TypeId& typeId, FunctorSignature function);
...
#include <vcore/console/console_functor.inl>
