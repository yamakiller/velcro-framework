#include <sstream>
#include <vcore/console/console_type_helpers.h>
...
namespace V
{
    ...
    (
        ...
        : m_callback(callback)
        , m_functor(name, desc, flags, VObject<BASE_TYPE>::Id(), *this, &ConsoleDataWrapper<BASE_TYPE, THREAD_SAFETY>::CvarFunctor)
    {
        this->m_value = value;
    }
