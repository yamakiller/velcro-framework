#ifndef V_FRAMEWORK_CORE_STATISTICS_RUNNING_STATISTIC_H
#define V_FRAMEWORK_CORE_STATISTICS_RUNNING_STATISTIC_H
...
namespace V {
     namespace Statistics
    {
        ...
        private:
            V::u64 m_numSamples;        /// How many times the method PushSample() has been called.
...
#endif // V_FRAMEWORK_CORE_STATISTICS_RUNNING_STATISTIC_H