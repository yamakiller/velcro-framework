...
namespace V::IO
{
    ...
    {
    public:
        VOBJECT_RTTI(IStreamer, "{a5f164fe-888b-45c2-b636-c8fe3b5e0a8f}");

        using OnCompleteCallback = VStd::function<void(FileRequestHandle)>;
        ...
        //! @param deadline The amount of time from calling Read that the request should complete. Is FileRequest::_noDeadline
        ...
        virtual FileRequestPtr Read(
            VStd::string_view relativePath,
            void* outputBuffer,
            size_t outputBufferSize,
            size_t readSize,
            VStd::chrono::microseconds deadline = IStreamerTypes::_noDeadline,
            IStreamerTypes::Priority priority = IStreamerTypes::_priorityMedium,
            size_t offset = 0) = 0;
        ...
        virtual FileRequestPtr RescheduleRequest(
            ...
            VStd::chrono::microseconds newDeadline,
        ...
        virtual FileRequestPtr CreateDedicatedCache(VStd::string_view relativePath) = 0;
        ...
        //! @param relativePath Relative path to the file to receive a dedicated cache. This can include aliases such as @products@.
        //! @return A reference to the provided request.
        virtual FileRequestPtr& CreateDedicatedCache(FileRequestPtr& request, VStd::string_view relativePath) = 0;
        ...
        virtual FileRequestPtr DestroyDedicatedCache(VStd::string_view relativePath) = 0;

        //! Destroy a dedicated cache created by CreateDedicatedCache. See CreateDedicatedCache for more details.
        //! @param request The request that will store the command to destroy a dedicated cache.
        //! @param relativePath Relative path to the file that got a dedicated cache. This can include aliases such as @products@.
        //! @return A reference to the provided request.
        virtual FileRequestPtr& DestroyDedicatedCache(FileRequestPtr& request, VStd::string_view relativePath) = 0;
        ...
        virtual FileRequestPtr FlushCache(VStd::string_view relativePath) = 0;
        ...
        //! @param relativePath Relative path to the file that will be cleared from all caches. This can include aliases such as @products@.
        //! @return A reference to the provided request.
        virtual FileRequestPtr& FlushCache(FileRequestPtr& request, VStd::string_view relativePath) = 0;
        ...
        virtual FileRequestPtr Custom(VStd::any data) = 0;

        //! Creates a custom request. This can be used by extensions to Streamer's stack to add their own commands.
        //! @param request The request that will store the custom command.
        //! @param data Storage for the arguments to the command.
        //! @return A reference to the provided request.
        virtual FileRequestPtr& Custom(FileRequestPtr& request, VStd::any data) = 0;
        ...
        virtual void CreateRequestBatch(VStd::vector<FileRequestPtr>& requests, size_t count) = 0;
        ...
        virtual void QueueRequestBatch(const VStd::vector<FileRequestPtr>& requests) = 0;
        ...
        //!     avoids repeatedly syncing with the Streamer's stack.
        //! @param requests The requests that will be processed.
        virtual void QueueRequestBatch(VStd::vector<FileRequestPtr>&& requests) = 0;
        ...
        virtual VStd::chrono::system_clock::time_point GetEstimatedRequestCompletionTime(FileRequestHandle request) const = 0;
        ...
        virtual void CollectStatistics(VStd::vector<Statistic>& statistics) = 0;
