...
#ifndef V_FRAMEWORK_CORE_IO_GENERIC_STREAMS_H
#define V_FRAMEWORK_CORE_IO_GENERIC_STREAMS_H
...
namespace V::IO
{
    ...
    using OffsetType = V::s64;
    enum class OpenMode : V::u32;

    /*
     * Base Class interface for implementing V::IO streams
     */
    class GenericStream
    {
    public:
    ...
    */
    ...
    public:
        ...
        bool CanRead() const override;
        bool CanWrite() const override;
        void Seek(V::IO::OffsetType, SeekMode) override;
        V::IO::SizeType Read(V::IO::SizeType, void*) override;
        V::IO::SizeType Write(V::IO::SizeType bytes, const void* iBuffer) override;
        V::IO::SizeType GetCurPos() const override;
        V::IO::SizeType GetLength() const override;
        V::IO::OpenMode GetModeFlags() const override;
    };
}   // namespace V::IO

#endif // V_FRAMEWORK_CORE_IO_GENERIC_STREAMS_H