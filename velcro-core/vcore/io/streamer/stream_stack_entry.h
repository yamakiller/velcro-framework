#ifndef V_FRAMEWORK_CORE_IO_STREAMER_STACK_ENTRY_H
#define V_FRAMEWORK_CORE_IO_STREAMER_STACK_ENTRY_H
...
namespace V
{
    namespace IO
    {
        ...
        public:
            ...
            virtual void SetNext(VStd::shared_ptr<StreamStackEntry> next);
            ...
            virtual VStd::shared_ptr<StreamStackEntry> GetNext() const;
            ...
            virtual void UpdateCompletionEstimates(VStd::chrono::system_clock::time_point now, VStd::vector<FileRequest*>& internalPending,
            ...
            //! purposes only.
            virtual void CollectStatistics(VStd::vector<Statistic>& statistics) const;
        ...
        protected:
            ...
            VStd::shared_ptr<StreamStackEntry> m_next;
...
#endif // V_FRAMEWORK_CORE_IO_STREAMER_STACK_ENTRY_H