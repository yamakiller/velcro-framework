...
namespace V::IO
{
    ...
    {
    public:
        using string_view_type = VStd::string_view;
        ...
        constexpr PathView(VStd::string_view pathView) noexcept;
        //! Constructs a PathView by the storing the supplied string_view
        //! The preferred separator it set to the parameter
        constexpr PathView(VStd::string_view pathView, const char preferredSeparator) noexcept;
        ...
        constexpr PathView& operator=(VStd::string_view pathView) noexcept;
        ...
        constexpr VStd::string_view Native() const noexcept;
        //! Conversion operator to retrieve string_view stored within the PathView
        constexpr explicit operator VStd::string_view() const noexcept;
        ...
        constexpr int Compare(VStd::string_view pathString) const noexcept;
        ...
        //! Returns a new instance of an VStd::fixed_string with capacity of MaxPathLength
        //! made from the internal string
        constexpr VStd::fixed_string<MaxPathLength> FixedMaxPathString() const noexcept;
        ...
        constexpr VStd::fixed_string<MaxPathLength> FixedMaxPathStringAsPosix() const noexcept;

        // decomposition
        //! Given a windows path of "C:\VELCRO\foo\bar\name.txt" and a posix path of
        //! "/VELCRO/foo/bar/name.txt"
        ...
        //! windows = "VELCRO\foo\bar\name.txt", posix = "VELCRO/foo/bar/name.txt"
        constexpr PathView RelativePath() const;
        //! Returns the parent directory of filename contained within the path
        //! windows = "C:\VELCRO\foo\bar", posix = "/VELCRO/foo/bar"
        ...
        //!   auto [a, b] = VStd::mismatch(begin(), end(), base.begin(), base.end())
        ...
        //! Ex. V::IO::PathView("a/b.ext").Match("*.ext") -> True
        //!     V::IO::PathView("a/b/c.ext").Match("b/*.ext") -> True
        //!     V::IO::PathView("a/b/c.ext").Match("a/*.ext") -> False
        //!
        //! # If the pattern is absolute, then the path must be absolute and the whole path must match
        //! is done from the end
        //! Ex. V::IO::PathView("/a.ext").Match("/*.ext") -> True
        //!     V::IO::PathView("a/b.ext").Match("/*.ext") -> False
        //!
        //! # a glob containing '*' will match a single component of a path
        //! Ex. V::IO::PathView("a/b/c.ext").Match("a/*/c.ext") -> True
        //! Ex. V::IO::PathView("a/d/e.ext").Match("a/*/*.ext") -> True
        //! Ex. V::IO::PathView("a/g/h.ext").Match("a/*/f.ext") -> False
        [[nodiscard]] constexpr bool Match(VStd::string_view pathPattern) const;
    ...
    private:
        ...
        friend struct VStd::hash<PathView>;
        struct PathIterable;

        static constexpr void MakeRelativeTo(PathIterable& pathResult, const V::IO::PathView& path, const V::IO::PathView& base) noexcept;
        ...
        static constexpr PathIterable GetNormalPathParts(const V::IO::PathView& path) noexcept;
        ...
        static constexpr void AppendNormalPathParts(PathIterable& pathIterableResult, const V::IO::PathView& path) noexcept;

        constexpr int ComparePathView(const PathView& other) const;
        constexpr VStd::string_view root_name_view() const;
        constexpr VStd::string_view root_directory_view() const;
        constexpr VStd::string_view root_path_raw_view() const;
        constexpr VStd::string_view relative_path_view() const;
        constexpr VStd::string_view parent_path_view() const;
        constexpr VStd::string_view filename_view() const;
        constexpr VStd::string_view stem_view() const;
        constexpr VStd::string_view extension_view() const;
    private:
        VStd::string_view m_path;
        value_type m_preferred_separator = V_TRAIT_OS_PATH_SEPARATOR;
    };
...
namespace V::IO
{
    ...
    public:
        ...
        //! The preferred separator is to the OS default path separator
        constexpr BasicPath(VStd::string_view src) noexcept;
        //! Constructs a Path by constructing it's internal out of a string_view
        //! The preferred separator is set to the parameter
        constexpr BasicPath(VStd::string_view src, const char preferredSeparator) noexcept;
        ...
        constexpr BasicPath& operator=(VStd::string_view str) noexcept;
        ...
        constexpr BasicPath& Assign(VStd::string_view pathView) noexcept;
        ...
        constexpr BasicPath& operator/=(VStd::string_view src);
        ...
        constexpr BasicPath& Append(VStd::string_view src);
        ...
        //! The string and wstring functions cannot be constexpr until VStd::basic_string is made constexpr.
        //! This cannot occur until C++20 as operator new/delete cannot be used within constexpr functions
        //! Returns a new instance of an VStd::string made from the internal string
        VStd::string String() const;

        // Extension for fixed strings
        //! extension: fixed string types with MaxPathLength capacity
        //! Returns a new instance of an VStd::fixed_string with capacity of MaxPathLength
        //! made from the internal string
        constexpr VStd::fixed_string<MaxPathLength> FixedMaxPathString() const;

        // as_posix
        //! Replicates the behavior of the Python pathlib as_posix method
        //! by replacing the Windows Path Separator with the Posix Path Seperator
        VStd::string StringAsPosix() const;
        constexpr VStd::fixed_string<MaxPathLength> FixedMaxPathStringAsPosix() const noexcept;
...
namespace V::IO
{
    ...
    public:
        ...
        using iterator_category = VStd::bidirectional_iterator_tag;
    ...
    private:
        ...
        VStd::string_view m_path_entry_view;
...
#include <vcore/io/path/path.inl>

#endif // V_FRAMEWORK_CORE_IO_PATH_PATH_H